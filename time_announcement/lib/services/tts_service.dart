...
class TTSScreen extends StatefulWidget {
  ...
  @override
  State<TTSScreen> createState() => tts_service();
}
enum TtsState { playing, completed}

class tts_service extends State<MyApp> with WidgetsBindingObserver {
    ...
    return MaterialApp(
      home: Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            children: [
              _inputSection(List<dynamic> inputText),
              _btnSection(),
  ...
  Widget _inputSection(List<dynamic> inputText)(
      if(mounted)(
